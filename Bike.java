...
public class Bike extends Vehicle {
	...
	public Bike(Colours colour, int maxSpeed) throws Exception {
		//Constructor override
		super("AAAA111", colour);
		numberOfDoors = 0;
		numberOfWheels = 2;
	...
	protected void setLicensePlate(String newPlate) { } //Override
	...
	protected void accelerate(int amount) { } //Override
	
	protected void brake(int amount) { } //Override
